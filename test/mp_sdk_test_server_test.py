...
from mp_sdk_test.mp_sdk_testImpl import mp_sdk_test
from mp_sdk_test.mp_sdk_testServer import MethodContext
from mp_sdk_test.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class mp_sdk_testTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('mp_sdk_test'):
        ...
        cls.serviceImpl = mp_sdk_test(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_mp_sdk_test_" + str(suffix)
